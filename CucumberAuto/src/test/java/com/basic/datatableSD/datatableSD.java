...
public class datatableSD {
	...
	@When("^enter folliwng data$")
	public void enter_folliwng_data(DataTable table) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@id='u_0_r']")).sendKeys(values6);
	}
}
